...
export const MOCK_PRODUCT_TRANSFER_LOCATIONS: ProductTransferLocationRow[] = [
  ...
  {
    id: 'loc-log01-warehouse',
    name: 'Log01 entrepot logtex',
    code: 'LOG01',
    warehouseRole: 'fulfilment',
    priority: 'very_high',
    transferHub: true,
    stock: { from: 0, to: 0 },
    ...
    forecastPerWeek: 0,
    stockouts: { from: 0, to: 0 },
    coverage: { fromPct: 0, toPct: 0, targetWeeks: 0 },
    storageCapacity: 'saturated',
  },
  {
    id: 'loc-log01-selling',
    name: 'Log01 entrepot logtex',
    code: 'LOG01',
    ...
    tuBreakdown: [
      {
        ...
        revenueIncrease: 380,
        reasons: [
          'Free saturated storage at Log01 entrepot logtex',
